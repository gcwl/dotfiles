--http://www.color-hex.com/color-palette/9173

local home = os.getenv("HOME")
local theme_base = home .. "/.config/awesome/themes/"
local theme_name = "flat/"
...
-- {{{ Colors
theme.fg_normal  = "#b4c0c0"
theme.fg_focus   = "#1abc9c"
theme.fg_urgent  = "#1abc9c"
theme.bg_normal  = "#22313f"
theme.bg_focus   = "#22313f"
-- theme.bg_urgent  = "#22313f"
...
theme.border_normal = "#22313f"
theme.border_focus  = "#0f705d"
theme.border_marked = "#f39c12"
-- }}}

-- {{{ Titlebars
theme.titlebar_bg_focus  = "#22313f"
theme.titlebar_bg_normal = "#22313f"
-- }}}
